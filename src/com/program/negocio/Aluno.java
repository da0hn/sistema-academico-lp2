...
import com.program.persistencia.AlunoDAO;
...
public class Aluno {
    ...
    public Aluno() throws NegocioException {
        try {
            this.alunoDAO = new AlunoDAO(DatabaseConnection.getInstance());
        }
    ...
    public AlunoVO pesquisaMatricula(int matricula) throws NegocioException {
        try {
            ...
            throw new NegocioException(
                    "Erro ao pesquisar aluno pela matricula - " + ex.getMessage());
        }
    }
    ...
    private String validarDados(AlunoVO alunoVO) {
        ...
        if(alunoVO.getEndereco().getEnumUf() == null) {
